...
function WorkSpaces() {
  ...
  return (
    <div class="dropdown">
      ...
      <i class="bi bi-pc-display-horizontal shade-hover rounded-2 p-2 dropdown-toggle" data-bs-toggle="dropdown" title="WorkSpaces" style="font-size:25px"></i> 
      
      <ul class="dropdown-menu">
        <li><a href="#" class="dropdown-item" onClick={[handleWorkSpace, null]}>Default</a></li>
        <li><hr class="dropdown-divider"></hr></li>
        <For each={allWorkSpaces()}>{(wsp) =>
          <li><a href="#" class="dropdown-item" onClick={[handleWorkSpace, wsp]}>{wsp.Name}</a></li>
        }</For>
      </ul>
    </div>
  );
